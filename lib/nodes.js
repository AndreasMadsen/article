...
Node.prototype._updateCounters = function () {
  // Do not include <script> and <style> in the density calculation
  ...
  for (var i = 0, l = this.children.length; i < l; i++) {
    ...
    this._tags += this.children[i]._tags;
  }
};

// Calculate the density
Node.prototype._updateDensity = function () {
  this.density = (this._tags === 0) ?
    this._stringLength : this._stringLength / this._tags;
};
