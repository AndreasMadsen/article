...
[
  'script', 'noscript', 'style', 'iframe', 'object', 'embed', 'video', 'audio'
].forEach(function (tagname) {
  NO_TEXT_ELEMENTS[tagname] = 1;
});
exports.NO_TEXT_ELEMENTS = NO_TEXT_ELEMENTS;

var IGNORE_TEXT_ELEMENT = {};
[
  'aside', 'caption', 'menu', 'details', 'fieldset', 'button', 'label', 'input', 'textarea'
].forEach(function (tagname) {
  IGNORE_TEXT_ELEMENT[tagname] = 1;
});
exports.IGNORE_TEXT_ELEMENT = IGNORE_TEXT_ELEMENT;
...
var INLINE_TEXT_TAGS = {};
[
  'strong', 'span', 'em', 'b', 'i', 'u',
  'del', 'ins', 'a', 'time', 'sub', 'sup',
  'big', 'small', 'tt', 'strike'
].forEach(function (tagname) {
  INLINE_TEXT_TAGS[tagname] = 1;
});
exports.INLINE_TEXT_TAGS = INLINE_TEXT_TAGS;
