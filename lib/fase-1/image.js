...
ImageAlgoritme.prototype.end = function () {
  for (var i = 0, l = this._allKeys.length; i < l; i++) {
    ...
    if (imageObject.href === 'http://a.abcnews.com/images/Health/ht_Lynda_Brackenridge_hospital_hep_a_berry_outbreak_thg_130605_wg.jpg') {
      console.log(imageObject);
      console.log(
        imageObject.extname === '.gif',
        ...
        (imageObject.types.img + imageObject.types.media) > 1
      );
    }
    ...
    // * picture showed more than once on the page
