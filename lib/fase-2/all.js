...
Fase2Algortime.prototype._reduceText = function () {
  ...
  // Get the 40 best subcontainer
  var subcontainers = tree
    .containerNodes()
  ...
  // Analuse the subcontainers
  subcontainers.forEach(analyser.collect.bind(analyser));
  ...
  console.log('node: ');
  console.log('  p: ',  mathHelpers.average(analyser.node.tagname.p || []) );
  console.log('  div: ', mathHelpers.average(analyser.node.tagname.div || []) );
  console.log('parent: ');
  console.log('  p: ', mathHelpers.average(analyser.parent.tagname.p || []) );
  console.log('  div: ', mathHelpers.average(analyser.parent.tagname.div || []) );
};
...
Fase2Algortime.prototype.result = function () {
  return {
    title: this._reducedTitleObject.getText().trim(),
